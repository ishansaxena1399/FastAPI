...
def test_return_user(test_user):
    ...
    assert response.json()['username'] == 'ishansaxena'
    assert response.json()['email'] == 'ishansaxena@email.com'
    assert response.json()['first_name'] == 'ishan'
    assert response.json()['last_name'] == 'saxena'
